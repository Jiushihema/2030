...
const ATTACK_PROFILES = {
  sensor: {
    ...
    autoDefenseHint: '开启后会在欺骗链路稳定后自动触发防御收敛，你也可以随时切回正常场景。',
    manualDefenseHint: '关闭后会保留持续欺骗态，直到切回正常场景。',
  },
  control: {
    selectionLabel: '影响焦点',
    targetHint: '后端当前使用统一控制注入通道，前端聚焦线路测控到断路器智能终端的控制传播与反馈。',
    backendMode: 'coarse-bridge',
    backendBadge: '粗粒度桥接',
    backendTone: 'bridge',
    backendLabel: '后端能力：已接入针对线路测控的恶意控制。',
