...
class OperatorStationDevice(BaseStationDevice):
	...
	def send_manual_command(self, target_bay_device: str, target_process_device: str, action: str) -> None:
		"""
		...
		self.send_to_peer(
			...
			payload={
				"target_bay_device": target_bay_device,
				"target_process_device": target_process_device,
				"action": action,
